        ...
        new ServerTreeTargetLifecycleCoordinatorFactory()
            .create(
                new ServerTreeTargetLifecycleCoordinatorFactory.Inputs(
                    ...
                    mock(ServerTreeEnsureNodeLeafInserter.Context.class),
                    ...
                    mock(ServerTreeTargetRemovalStateCoordinator.Context.class),
                    mock(ServerTreeTargetNodeRemovalMutator.class),
                    mock(ServerTreeTargetNodeRemovalMutator.Context.class),
                    () -> true,
                    __ -> {},
                    __ -> "",
                    (__1, __2) -> {},
