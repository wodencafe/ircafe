...
final class ChatTranscriptInteractionCoordinator {
  ...
  ChatTranscriptInteractionCoordinator(
  ...
  boolean onNickClicked(String nick) {
    TargetRef activeTarget = activeTargetSupplier.get();
  ...
  boolean onChannelClicked(String channel) {
    TargetRef activeTarget = activeTargetSupplier.get();
  ...
  boolean onMessageReferenceClicked(String messageId) {
    TargetRef activeTarget = activeTargetSupplier.get();
