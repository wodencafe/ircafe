...
final class DccActionCoordinator {
  ...
  DccActionCoordinator(Component ownerComponent, BiConsumer<TargetRef, String> commandEmitter) {
    this(
        ownerComponent,
        commandEmitter,
        JFileChooser::new,
  ...
  void requestAction(TargetRef ctx, String nick, NickContextMenuFactory.DccAction action) {
    if (ctx == null) return;
