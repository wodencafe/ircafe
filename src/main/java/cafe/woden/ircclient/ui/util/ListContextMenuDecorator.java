 ...
 *
 * <ul>
 *   <li>On popup trigger: determine index under mouse (if any)
 *   <li>Optionally select that index
 *   <li>Build a menu and show it at the mouse location
 * </ul>
 */
    ...
    this.mouse =
        new MouseAdapter() {
          ...
          private int indexAt(Point p) {
            ...
            if (idx < 0) return -1;
            // locationToIndex returns nearest row; verify the click is actually inside the cell
            // bounds.
