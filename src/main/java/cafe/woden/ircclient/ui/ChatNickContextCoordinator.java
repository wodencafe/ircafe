...
final class ChatNickContextCoordinator {
  ...
  JPopupMenu nickContextMenuFor(String nick) {
  ...
  void promptIgnore(TargetRef target, String nick, boolean removing, boolean soft) {
