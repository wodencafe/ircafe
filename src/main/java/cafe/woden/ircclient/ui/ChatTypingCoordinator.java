...
final class ChatTypingCoordinator {
  ...
  void showTypingIndicator(TargetRef target, String nick, String state) {
  ...
  void normalizeIrcv3CapabilityUiState(String serverId, String capability) {
  ...
  void onLocalTypingStateChanged(String state) {
  ...
  void refreshTypingSignalAvailabilityForActiveTarget() {
    TargetRef target = activeTargetSupplier.get();
