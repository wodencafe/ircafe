 ...
 */
final class ChatMonitorCoordinator {
  ...
  void setPrivateMessageOnlineState(String serverId, String nick, boolean online) {
  ...
  void refreshMonitorRows(String serverId) {
    String sid = Objects.toString(serverId, "").trim();
    if (sid.isEmpty()) {
