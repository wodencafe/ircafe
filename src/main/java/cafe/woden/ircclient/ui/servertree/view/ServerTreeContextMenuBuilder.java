...
public final class ServerTreeContextMenuBuilder {
  ...
  public ServerTreeContextMenuBuilder(Context context) {
    ...
    this.serverNodeMenuBuilder = new ServerTreeServerNodeMenuBuilder(this.context);
    this.targetNodeMenuBuilder = new ServerTreeTargetNodeMenuBuilder(this.context);
  }
