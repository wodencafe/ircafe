...
public enum BuiltInSound {
  ...
  SOMEBODY_SAID_SOMETHING_2("Somebody Said Something", "sounds/voice/somebody_said_something_2.mp3"),
  SOMEBODY_SAID_SOMETHING_3("Somebody Said Something", "sounds/voice/somebody_said_something_3.mp3"),
  SOMEBODY_SAID_SOMETHING_4("Somebody Said Something", "sounds/voice/somebody_said_something_4.mp3"),
  SOMEBODY_SAID_SOMETHING_5("Somebody Said Something", "sounds/voice/somebody_said_something_5.mp3"),
  SOMEBODY_SAID_SOMETHING_6("Somebody Said Something", "sounds/voice/somebody_said_something_6.mp3"),
