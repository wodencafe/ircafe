...
final class PircbotxChatHistoryBatchCollector {
  ...
  boolean maybeCaptureUnknownLine(String originalLineWithTags, String normalizedLine) {
    Optional<String> maybeBatchId = PircbotxIrcv3BatchTag.fromRawLine(originalLineWithTags);
