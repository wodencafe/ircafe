...
@ApplicationLayer
public final class OutboundCommandRegistry {

  @FunctionalInterface
  public interface Handler<T extends ParsedInput> {
  ...
  public <T extends ParsedInput> void register(Class<T> commandType, Handler<T> handler) {
